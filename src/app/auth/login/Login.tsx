...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.error("OAuth handshake exception:", error);
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="flex flex-col gap-4">
          <button
            ...
            className="flex items-center justify-center gap-3 w-full cursor-pointer border border-border rounded-md px-4 py-2 text-sm font-medium hover:bg-secondary transition-colors disabled:opacity-60 disabled:cursor-not-allowed select-none"
          >
            {isGoogleLoading ? (
